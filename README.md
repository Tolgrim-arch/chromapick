...
<div align="center">
  <br>
  <a href="https://Tolgrim-arch.github.io/chromapick/">
    <img src="https://img.shields.io/badge/LAUNCH%20WEB%20APP-%23ef4444.svg?style=for-the-badge&logo=Google-Chrome&logoColor=white" height="60" alt="Launch App" />
  </a>
  <br><br>
  <strong>📱 100% Mobile Ready. No installation required. Works directly in your phone's browser.</strong>
  <br><br>
</div>
...
- **Modern CSS3** (Flexbox, Grid, custom properties, responsive media queries)

## 🎯 Usage

1. Open the [Web App](https://Tolgrim-arch.github.io/chromapick/) from your PC or Mobile device.
2. Paste (Ctrl+V), drag & drop, or select an image from your gallery.
3. Use the **Extractor** tab to get dominant palettes and filter by algorithm.
4. Hover/Touch the canvas to pick an exact pixel with the precision magnifying glass.
5. Save your favorite palettes to local storage, or use the **Converter** tab to get exact mathematical harmonies.
6. Click any color to instantly copy its HEX/RGB value to your clipboard.

---

### About (Repository Description)
*If you need to paste this into the GitHub Repository "About" section settings:*
> **"An offline-first, client-side web application for extracting color palettes, generating visual harmonies, and translating formats with surgical precision using Vanilla JS."**
